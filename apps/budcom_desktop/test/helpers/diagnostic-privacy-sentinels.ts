 ...
 * data never survives BUDCOM's diagnostic sanitization/redaction pipeline. Moved out of
 * src/application/diagnostic-allowlist.ts (public-release hygiene audit, 2026-08-17): that module
 * compiles into apps/budcom_desktop/dist/application/diagnostic-allowlist.js, which ships inside

...
exports.mapLifecycleUserMessage = mapLifecycleUserMessage;
exports.mapSpawnError = mapSpawnError;
exports.mapLifecycleStateLabel = mapLifecycleStateLabel;
const MESSAGES = {
...
function mapLifecycleUserMessage(reason, detail) {
    if (detail) {
        return detail;
    }
...
function mapLifecycleStateLabel(state) {
    switch (state) {
        case 'starting':
            return 'Starting';
        case 'connected':
...
//# sourceMappingURL=lifecycle-error-mapper.js.map
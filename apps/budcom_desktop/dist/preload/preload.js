...
const desktopBridge = {
    ...
    validateSettings: (input) => electron_1.ipcRenderer.invoke('desktop:validate-settings', input),
    saveSettings: (input) => electron_1.ipcRenderer.invoke('desktop:save-settings', input),
    restoreDefaultSettings: () => electron_1.ipcRenderer.invoke('desktop:restore-default-settings'),
    ...
    getDiagnostics: () => electron_1.ipcRenderer.invoke('desktop:get-diagnostics'),
    refreshDiagnostics: () => electron_1.ipcRenderer.invoke('desktop:refresh-diagnostics'),
    copyDiagnosticsSummary: () => electron_1.ipcRenderer.invoke('desktop:copy-diagnostics-summary'),
    exportDiagnosticsBundle: () => electron_1.ipcRenderer.invoke('desktop:export-diagnostics-bundle'),
    openLogsFolder: () => electron_1.ipcRenderer.invoke('desktop:open-logs-folder'),
    clearNonessentialLogs: () => electron_1.ipcRenderer.invoke('desktop:clear-nonessential-logs'),
    runHealthCheck: () => electron_1.ipcRenderer.invoke('desktop:run-health-check'),
    reloadRenderer: () => electron_1.ipcRenderer.invoke('desktop:reload-renderer'),

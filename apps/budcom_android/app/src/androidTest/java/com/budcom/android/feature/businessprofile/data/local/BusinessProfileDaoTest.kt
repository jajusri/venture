...
class BusinessProfileDaoTest {
    ...
    fun updatingOnlyTheLogoPreservesEveryOtherField() = runBlocking {
        ...
        dao.upsert(existing.copy(logoAssetPath = "/data/user/0/com.budcom.android.debug/files/business_profile_logos/co-a.png"))
        ...
        assertEquals("/data/user/0/com.budcom.android.debug/files/business_profile_logos/co-a.png", updated?.logoAssetPath)
    }

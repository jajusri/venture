...
/** The editable field set — mirrors [com.budcom.android.feature.businessprofile.domain.model.BusinessProfileDraft]'s
 * shape but as plain editable strings (never null, matching every other BUDCOM text-field dialog's

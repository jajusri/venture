 ...
 * Estimate/PO's prices at all (docs/architecture/BUDCOM-TRANSACTION-MODE-ARCHITECTURE.md §10, task's
 ...
 * override-resolution chain or [com.budcom.android.feature.transaction.domain.model.CatalogueAccessGrant];
...
enum class TransactionSharePriceVisibility {
     ...
     * price" regardless of what its own snapshot amount/[com.budcom.android.feature.transaction.domain.model.TransactionLineItem.isContactForPrice]
 ...
 * mechanism [com.budcom.android.feature.catalogue.sharing.CatalogueShareCoordinator] already uses
...
interface TransactionShareCoordinator {
    suspend fun prepareShare(
        companyId: String,
        estimatePo: com.budcom.android.feature.transaction.domain.model.EstimatePo,
        priceVisibility: TransactionSharePriceVisibility,
        businessName: String?,
        buyerDisplayName: String?,
        terms: com.budcom.android.feature.transaction.domain.model.TermsAcknowledgment? = null,

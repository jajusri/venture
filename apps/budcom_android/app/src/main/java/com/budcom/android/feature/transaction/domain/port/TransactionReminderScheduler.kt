 ...
 * (docs/architecture/BUDCOM-TRANSACTION-MODE-ARCHITECTURE.md Finding 2 / §13). **This codebase has
 ...
 *
 * This interface exists so [com.budcom.android.feature.transaction.data.repository.TransactionRepositoryImpl]
...
interface TransactionReminderScheduler {
    /** Called once a transaction reaches [com.budcom.android.feature.transaction.domain.model.CommercialTransactionState.Agreed]
    ...
    /** Called once a transaction reaches [com.budcom.android.feature.transaction.domain.model.CommercialTransactionState.Completed]

 ...
 * [com.budcom.android.feature.connect.presentation.ConnectEffect], which carries plain phone
 * strings, not Intents).
 */
object ConnectContactActions {
     ...
     * [com.budcom.android.core.util.PhoneNumberNormalizer]-validated E.164 number already used
     * for [callIntent]).
     */

 ...
 * proven pattern [com.budcom.android.feature.businessprofile.storage.BusinessProfileLogoStore]
...
interface CatalogueAssetStore {
     ...
     * to persist in [com.budcom.android.feature.catalogue.data.local.CatalogueAssetEntity.filePath].

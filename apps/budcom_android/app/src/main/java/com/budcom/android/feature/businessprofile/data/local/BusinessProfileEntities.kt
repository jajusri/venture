 ...
 * needed. 100% BUDCOM-owned data (PDL-019): deliberately no field-provenance tracking, no Tally
 * source-link reference — [com.budcom.android.feature.party.data.local.PartyFieldProvenanceEntity]'s

package com.budcom.android.core.pairing.domain

/**
 * Explicit secure-pairing domain states. [ReadSecurePairingState][com.budcom.android.core.pairing.domain.usecase.ReadSecurePairingState]
 * only ever produces the four "steady" states below (a direct reflection of the vault's own
 * [com.budcom.android.core.pairing.domain.model.SecurePairingCredentialState], plus the

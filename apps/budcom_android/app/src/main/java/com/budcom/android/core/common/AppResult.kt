 ...
 *
 * Network-layer [com.budcom.android.core.network.NetworkError] values are mapped here
 * by [com.budcom.android.core.network.ErrorMapper] so domain code stays transport-agnostic.
 */

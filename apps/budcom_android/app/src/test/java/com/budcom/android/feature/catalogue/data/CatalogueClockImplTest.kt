 ...
 * case — and every Catalogue write calls [com.budcom.android.feature.catalogue.domain.port.CatalogueClock.now()].
...
class CatalogueClockImplTest {
    ...
    fun `a probe failure falls back to the device clock immediately`() = runTest {
        val port = SlowConnectorStatusPort(10L, AppResult.Failure(com.budcom.android.core.common.AppError.Offline()))

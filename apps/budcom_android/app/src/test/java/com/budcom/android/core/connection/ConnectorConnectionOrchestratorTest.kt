...
import com.budcom.android.core.network.DynamicBaseUrlInterceptor
...
class ConnectorConnectionOrchestratorTest {
    ...
    fun `resolved endpoint becomes the live base URL every Retrofit request actually hits`() = runTest {
        ...
        try {
            ...
            val provider = com.budcom.android.core.network.DefaultConnectorBaseUrlProvider()
            val baseUrlStore = object : com.budcom.android.feature.serverconfig.data.local.ConnectorBaseUrlLocalStore {
            ...
            val realResolver = DefaultConnectorConnectionResolver(
                ...
                discoveryPort = com.budcom.android.core.discovery.FakeConnectorDiscoveryPort(),
                baseUrlProvider = provider,
                baseUrlLocalStore = baseUrlStore,
                timeProvider = com.budcom.android.core.util.TimeProvider { 99L },
            )
            val orchestrator = DefaultConnectorConnectionOrchestrator(

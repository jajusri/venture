...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "APP_NAME", "\"Venture\"")
    }

    // DEV isolation (infrastructure only — see docs/status/VENTURE-DEVELOPMENT-LEDGER.md's DEV
    ...
    // flavor dimension existed (com.jajusri.venture[.debug]) — the already-installed device app is
    ...
    productFlavors {
        ...
        create("dev") {
            ...
            buildConfigField("String", "APP_NAME", "\"VENTURE DEV\"")
        }
    }

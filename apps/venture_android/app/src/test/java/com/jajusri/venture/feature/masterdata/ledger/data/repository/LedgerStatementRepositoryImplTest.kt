...
private class StatementFakeRemote(private val result: ApiResult<LedgerStatement>) : LedgerRemoteDataSource {
    ...
    override suspend fun fetchLedgers(
        query: com.jajusri.venture.feature.masterdata.ledger.domain.model.LedgerQuery,
    ): ApiResult<com.jajusri.venture.feature.masterdata.ledger.domain.model.LedgerPage> =
    ...
    override suspend fun fetchLedgerContactDetails(
        ledgerId: String,
    ): ApiResult<com.jajusri.venture.feature.masterdata.ledger.domain.model.LedgerContactDetails> =
        error("fetchLedgerContactDetails is not exercised by ledger-statement tests")

    override suspend fun fetchLedgerContactDetailsBulk(): ApiResult<com.jajusri.venture.feature.masterdata.ledger.domain.model.LedgerContactDetailsBulkResult> =

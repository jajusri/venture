package com.jajusri.venture.feature.party.domain.usecase
 ...
 * fake's own boundary (the real [com.jajusri.venture.feature.masterdata.ledger.data.repository.LedgerSnapshotPortImpl]
...
private class FakePartyRepository : PartyRepository {
    ...
    override suspend fun getSourceLinksForCompany(companyId: String): List<com.jajusri.venture.feature.party.domain.model.PartySourceLink> = emptyList()

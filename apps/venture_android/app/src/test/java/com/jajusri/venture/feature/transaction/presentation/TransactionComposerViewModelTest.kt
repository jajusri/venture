...
import com.jajusri.venture.feature.transaction.sharing.PreparedTransactionShare
...
class TransactionComposerViewModelTest {
    ...
    private fun completedTransaction(companyId: String, buyerPartyId: String, estimatePoId: String, acceptedAtMillis: Long) = CommercialTransaction(
        ...
        state = com.jajusri.venture.feature.transaction.domain.model.CommercialTransactionState.Completed,
    ...
    private fun estimatePoWithLine(companyId: String, estimatePoId: String, buyerPartyId: String, productId: String, qty: String) = EstimatePo(
        companyId = companyId, estimatePoId = estimatePoId, entryPointType = com.jajusri.venture.feature.transaction.domain.model.TransactionEntryPointType.Catalogue,
        submissionType = com.jajusri.venture.feature.transaction.domain.model.TransactionSubmissionType.Estimate,
        deliveryChannel = TransactionDeliveryChannel.WhatsAppShared, buyerPartyId = buyerPartyId, totalAmount = "500", currencyCode = "INR",
        status = com.jajusri.venture.feature.transaction.domain.model.EstimatePoStatus.Shared, submittedAt = ts(0),
...
class TransactionComposerRealCatalogueTest {
    ...
    private fun snapshot(
        ...
        primaryAssetId = null, publishedAt = CatalogueTimestamp(1_000L, com.jajusri.venture.feature.catalogue.domain.model.CatalogueTimestampSource.DeviceLocalProvisional),
    )
 ...
 * [com.jajusri.venture.feature.transaction.data.repository.TransactionRepositoryImplTest]'s own

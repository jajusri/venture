...
private fun sampleSnapshot(
    ...
    priceDisplayMode = com.jajusri.venture.feature.catalogue.domain.model.PriceDisplayMode.ContactForPrice,
    resolvedPriceAmount = null,
    resolvedPriceCurrencyCode = null,
    primaryAssetId = null,
    publishedAt = com.jajusri.venture.feature.catalogue.domain.model.CatalogueTimestamp(
        1_000L, com.jajusri.venture.feature.catalogue.domain.model.CatalogueTimestampSource.DeviceLocalProvisional,
    ),
)
...
private class FakeShareRepository(private val isPublic: Boolean) : CatalogueRepository {
    ...
    override suspend fun addAsset(
        ...
        timestamp: CatalogueTimestamp,
    ): com.jajusri.venture.feature.catalogue.storage.CatalogueAssetResult = error("not used in these tests")

...
class SyncDtoMappingTest {
    ...
    fun ledgerResultMapsCompletedWithWarnings() {
        ...
        val outcome = dto.toOutcome() as com.jajusri.venture.feature.sync.domain.model.SyncOutcome.Succeeded
    ...
    fun statusResponseCarriesSchedulerStateIntoTheDomainProgress() {
        ...
        assertEquals(com.jajusri.venture.feature.sync.domain.model.SchedulerStage.ActiveWindow, progress.schedulerState?.stage)
    ...
    fun unknownSchedulerStageStringMapsToUnknownRatherThanCrashing() {
        ...
        assertEquals(com.jajusri.venture.feature.sync.domain.model.SchedulerStage.Unknown, dto.toDomain().stage)
    }
    ...
    fun stockPartialMapsPartialSuccess() {
        ...
        assertTrue(outcome is com.jajusri.venture.feature.sync.domain.model.SyncOutcome.PartiallySucceeded)
    }
}

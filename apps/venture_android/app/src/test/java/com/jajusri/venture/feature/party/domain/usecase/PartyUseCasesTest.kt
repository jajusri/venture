...
private abstract class ThrowingPartyRepository : PartyRepository {
    ...
    override suspend fun listByClassification(companyId: String, classification: com.jajusri.venture.feature.party.domain.model.PartyClassification, page: Int, pageSize: Int): PartyPage = error("unused")
    override suspend fun searchParties(companyId: String, query: String, classification: com.jajusri.venture.feature.party.domain.model.PartyClassification?, page: Int, pageSize: Int): PartyPage = error("unused")
    ...
    override suspend fun updateVentureOnlyField(companyId: String, partyId: String, fieldName: String, value: String?): FieldProvenanceState = error("unused")
    ...
    override suspend fun getIssueActivitySummary(companyId: String, partyId: String): Map<String, com.jajusri.venture.feature.party.domain.model.IssueActivitySummary> = error("unused")

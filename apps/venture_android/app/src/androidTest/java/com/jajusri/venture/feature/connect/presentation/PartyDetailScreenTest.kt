...
class PartyDetailScreenTest {
    ...
    private fun fieldRow(
        ...
        provenanceLabel: String = "Pending in VENTURE",
    ...
    private fun contact(id: String = "c1", isPrimary: Boolean = false) = PartyContactPerson(
        ...
        isPrimary = isPrimary, provenance = FieldProvenanceState.VentureOnlyPending, createdAt = 0L, updatedAt = 0L,
    )
    ...
    private fun note(
        ...
        type: com.jajusri.venture.feature.party.domain.model.NoteType = com.jajusri.venture.feature.party.domain.model.NoteType.General,
        dueAt: Long? = null,
    ...
    private fun timelineOf(vararg notes: PartyNote): List<com.jajusri.venture.feature.party.domain.model.TimelineEntry> =
        notes.map { com.jajusri.venture.feature.party.domain.model.TimelineEntry.NoteEvent(it) }
    ...
    fun loadingState() {
        composeRule.setContent {
            VentureTheme { PartyDetailScreen(state = PartyDetailUiState(isLoading = true), onEvent = {}) }
        }
            ...
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        isLoading = false,
                        party = party(),
                        timeline = timelineOf(note(type = com.jajusri.venture.feature.party.domain.model.NoteType.FollowUp, dueAt = 1_700_000_000_000L)),
                    ),
                    onEvent = { lastEvent = it },
                )
            }
            ...
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        ...
                        timeline = timelineOf(
                            note(
                                type = com.jajusri.venture.feature.party.domain.model.NoteType.Commitment,
            ...
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        isLoading = false,
                        party = party(),
                        timeline = listOf(com.jajusri.venture.feature.party.domain.model.TimelineEntry.ExportEvent(event)),
                    ),
                    onEvent = {},
                )
            }
            ...
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        ...
                        party = party(),
                        timeline = listOf(
                            com.jajusri.venture.feature.party.domain.model.TimelineEntry.NoteEvent(note(id = "n1")),
                            com.jajusri.venture.feature.party.domain.model.TimelineEntry.ExportEvent(event),
                        ),
                    ),
                    onEvent = {},
                )
        ...
        composeRule.setContent {
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        isLoading = false, party = party(),
                        timeline = listOf(com.jajusri.venture.feature.party.domain.model.TimelineEntry.IssueOpenedEvent("i1", "Short shipment", 0L)),
                    ),
                    onEvent = {},
                )
            }
    ...
    fun pickingANoteTypeEmitsNoteTypeChanged() {
        ...
        assertEquals(
            PartyDetailEvent.NoteTypeChanged(com.jajusri.venture.feature.party.domain.model.NoteType.Commitment),
            lastEvent,
        )
    }
            ...
            VentureTheme {
                PartyDetailScreen(
                    state = PartyDetailUiState(
                        isLoading = false,
                        party = party(),
                        activeDialog = PartyDetailDialog.NoteEditor(type = com.jajusri.venture.feature.party.domain.model.NoteType.Commitment),
                    ),
                    onEvent = {},
                )
            }

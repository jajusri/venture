...
import com.jajusri.venture.feature.voucher.data.local.VoucherDetailEntity
import com.jajusri.venture.feature.voucher.data.local.VoucherEntity
import com.jajusri.venture.feature.voucher.data.local.VoucherLedgerLineEntity
 ...
 * to the real [com.jajusri.venture.feature.masterdata.ledger.data.local.LedgerDao] and
 * [com.jajusri.venture.feature.masterdata.ledger.data.local.LedgerMovementDao] — no fakes anywhere in
 * this file. Data is seeded exclusively through [com.jajusri.venture.feature.voucher.data.local.VoucherDao.storeListWithDetails],
 * the exact production entry point [com.jajusri.venture.feature.voucher.data.repository.VoucherRepositoryImpl.refreshVouchers]
...
class GetLocalLedgerStatementUseCaseIntegrationTest {
    ...
    /** Mirrors exactly one [com.jajusri.venture.feature.voucher.data.repository.VoucherRepositoryImpl.refreshVouchers] call. */

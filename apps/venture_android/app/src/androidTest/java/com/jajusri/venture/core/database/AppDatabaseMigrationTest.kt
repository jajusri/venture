    ...
    fun migrate5To6_preservesExistingRowsAndAddsPartyTablesOnly() {
        ...
        assertEquals(
            mapOf(
                ...
                "tallyValue" to "TEXT", "ventureValue" to "TEXT", "lastConfirmedAt" to "INTEGER",
        ...
        db.execSQL(
            "INSERT INTO party_field_provenance (companyId, partyId, fieldName, state, tallyValue, ventureValue, " +
        ...
        db.execSQL(
            "INSERT INTO party_contact_persons (companyId, contactPersonId, partyId, name, designation, mobile, " +
                ...
                "1, 'venture_only', 1736899200000, 1736899200000)",
        )
        db.query(
    ...
    fun migrate7To8_preservesExistingRowsAndAddsPartyExportEventsTableOnly() {
        ...
        db.execSQL(
            "INSERT INTO party_export_events (companyId, exportId, partyId, createdAt, outputFileName, " +
                ...
                "'VENTURE-Tally-Export-ABC-Traders-1.xml', 'primaryEmail,gstin')",
        )
        db.query(

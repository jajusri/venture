 ...
 * [com.jajusri.venture.feature.masterdata.ledger.domain.usecase.GetLocalLedgerStatementUseCaseTest]
...
class LedgerMovementDaoTest {
    ...
    fun movementsInRange_sameDayRowsTieBreakDeterministicallyByVoucherIdAscending() = runBlocking {
        ...
        // VoucherPublicDetails in venture_connector's voucher-dtos.ts), so this DAO's own doc

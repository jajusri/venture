...
class DincharyaScreenTest {
    ...
    fun loadingState() {
        composeRule.setContent {
            VentureTheme { DincharyaScreen(state = DincharyaUiState(isInitialLoading = true), onEvent = {}) }
        }
    ...
    fun emptyStateIsShownAsAGenuinePositiveMessage() {
        composeRule.setContent {
            VentureTheme { DincharyaScreen(state = DincharyaUiState(isInitialLoading = false), onEvent = {}) }
        }

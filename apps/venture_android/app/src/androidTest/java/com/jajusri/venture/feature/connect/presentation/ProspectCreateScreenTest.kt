...
class ProspectCreateScreenTest {
    ...
    fun saveIsDisabledWithoutADisplayName() {
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(), onEvent = {}, onBack = {}) }
        }
    ...
    fun saveIsEnabledOnceANameIsPresent() {
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(displayName = "New Bakery"), onEvent = {}, onBack = {}) }
        }
    ...
    fun typingTheNameFieldEmitsDisplayNameChanged() {
        ...
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(), onEvent = { lastEvent = it }, onBack = {}) }
        }
    ...
    fun tappingSaveEmitsSave() {
        var lastEvent: ProspectCreateEvent? = null
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(displayName = "New Bakery"), onEvent = { lastEvent = it }, onBack = {}) }
        }
    ...
    fun savingShowsAProgressLabel() {
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(displayName = "New Bakery", isSaving = true), onEvent = {}, onBack = {}) }
        }
        composeRule.onNodeWithTag("prospect_save").assertIsNotEnabled()
    }
    ...
    fun tappingBackInvokesOnBack() {
        ...
        composeRule.setContent {
            VentureTheme { ProspectCreateScreen(state = ProspectCreateUiState(), onEvent = {}, onBack = { backCalled = true }) }
        }

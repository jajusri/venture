...
class CompanyScreenTest {
    ...
    fun companyListScrollsToAndSelectsSecondItem() {
        ...
        composeRule.onNodeWithTag("company_card_venture-test-01").assertIsDisplayed()
...
private fun twoCompanyState() = CompanyUiState(
    isLoading = false,
    companies = listOf(
        ConnectorCompany("venture-test-01", "Venture-Test-01", null, null, "INR"),
        ConnectorCompany("estimation", "ESTIMATION", null, null, "INR"),
    ),
    filteredCompanies = listOf(
        ConnectorCompany("venture-test-01", "Venture-Test-01", null, null, "INR"),
    ...
    selectedCompanyId = "venture-test-01",
    selectedCompanyName = "Venture-Test-01",
)

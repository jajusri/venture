package com.jajusri.venture.core.connectorauth.domain.model
...
/**
 * The narrow, single-request context [com.jajusri.venture.core.connectorauth.data.remote.AuthenticatedConnectorApiPort]
 * needs: the [TrustedConnectorEndpoint] to dial and a transiently-held bearer credential to
 * present. Constructible only by
 * [com.jajusri.venture.core.connectorauth.domain.AuthenticatedConnectorContextProvider] from a
 ...
 *
 * [credentialId] is the non-secret [com.jajusri.venture.core.pairing.domain.model.SecurePairingCredentialRecord.credentialId]
 * this context's bearer was decrypted from — carried through to a rejected request's
 * [com.jajusri.venture.core.connectorauth.domain.model.AuthenticatedConnectorResult.Unauthorized]

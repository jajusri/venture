...
import com.jajusri.venture.core.pairing.domain.model.SecurePairingQrPayloadRejection
...
import com.jajusri.venture.core.pairing.domain.usecase.SecurePairingRedemptionOutcome
...
private fun rejectionMessage(rejection: SecurePairingQrPayloadRejection): String = when (rejectionPhase(rejection)) {
    ...
    // safely be told. Never surfaces the rejected host/IP itself.
        ...
        "VENTURE Desktop is not ready for mobile pairing. Generate a new QR code on the computer."
    } else {
        "This QR code is not a valid VENTURE pairing code."
    }
}

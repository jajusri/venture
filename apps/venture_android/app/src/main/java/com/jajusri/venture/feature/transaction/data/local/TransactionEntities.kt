 ...
 * (docs/architecture/VENTURE-TRANSACTION-MODE-ARCHITECTURE.md §4-§10, §12, §14). Every table
...
data class EstimatePoEntity(
    ...
    /** "CATALOGUE" or "CHAT" — [com.jajusri.venture.feature.transaction.domain.model.TransactionEntryPointType]. */
 ...
 * [com.jajusri.venture.feature.transaction.domain.model.TransactionDeliveryChannel.InAppSubmitted]
 * submissions, enforced structurally in [com.jajusri.venture.feature.transaction.data.repository.TransactionRepositoryImpl],
...
data class CommercialTransactionEntity(
     ...
     * — a cached projection of [com.jajusri.venture.feature.transaction.domain.model.TransactionStateDerivation.deriveState],
...
data class CatalogueAccessGrantEntity(
    ...
    val grantId: String,
    val buyerPartyId: String,
    /** "OPEN" — see [com.jajusri.venture.feature.transaction.domain.model.CataloguePriceVisibilityGrant]'s

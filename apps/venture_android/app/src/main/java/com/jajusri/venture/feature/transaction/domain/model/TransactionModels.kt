...
/**
 * Transaction Mode domain models (docs/architecture/VENTURE-TRANSACTION-MODE-ARCHITECTURE.md §4-§10).
 *
 ...
 * [com.jajusri.venture.feature.catalogue.domain.model.CatalogueOverrideAttribute]'s own
 ...
 * read-time modifier (see [com.jajusri.venture.feature.transaction.domain.model.isOverdue]), never a
...
/** Mirrors [com.jajusri.venture.feature.catalogue.domain.model.CatalogueTimestampSource]'s own
...
/** See [com.jajusri.venture.feature.transaction.data.TransactionClockImpl] for resolution logic. */
...
data class TransactionLineItem(
     ...
     * [com.jajusri.venture.feature.catalogue.domain.model.CataloguePriceState]'s own
...
data class TermsAcknowledgment(
     ...
     * [com.jajusri.venture.feature.transaction.domain.model.MAX_TERMS_NOTE_LENGTH]. */
    val note: String?,

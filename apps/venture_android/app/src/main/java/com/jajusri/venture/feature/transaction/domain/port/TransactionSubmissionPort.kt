...
/**
 * HARD ARCHITECTURAL BOUNDARY (docs/architecture/VENTURE-TRANSACTION-MODE-ARCHITECTURE.md Finding 1
 ...
 *
 * This interface is the seam that keeps [com.jajusri.venture.feature.transaction.data.repository.TransactionRepositoryImpl]
...
interface TransactionSubmissionPort {
    /**
     * Delivers an already-persisted, [com.jajusri.venture.feature.transaction.domain.model.TransactionDeliveryChannel.InAppSubmitted]

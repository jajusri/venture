...
fun ConnectorDiscoveryScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(title = { Text("Find your VENTURE Connector") })
        },
    ) { innerPadding ->
        Column(
            modifier = Modifier
...
private fun DiscoveringContent() {
    Column(
        ...
        Text("Searching for VENTURE Connector on this network…")
    }
}
...
private fun EmptyContent(
    ...
    Column(
        ...
        Text(
            text = "No VENTURE Connector found.",
            style = MaterialTheme.typography.titleMedium,
        )
        Text(
            text = "Make sure VENTURE Desktop is running and this device is on the same network.",

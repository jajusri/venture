 ...
 * route matrix (see `VENTURE_PHASE3P_AUTHENTICATED_ROUTE_CALLER_MATRIX_20260805_200456.csv`),
 ...
 * [com.jajusri.venture.core.connectorauth.data.remote.AuthenticatedConnectorApiPort].
 *
...
sealed class AuthenticatedConnectorOperation(
     ...
     * `connector/venture_connector/src/api/routes/vouchers.ts`'s `requireCompany` call). Unlike

...
import com.jajusri.venture.feature.masterdata.presentation.formatAccountDataFreshness
            ...
            it.copy(
                ...
                bannerError = when (outcome) {
                    ...
                    is SyncOutcome.Conflict ->
                        com.jajusri.venture.feature.masterdata.presentation.MasterDataUiError.Message(outcome.message)
                    else -> null
                },

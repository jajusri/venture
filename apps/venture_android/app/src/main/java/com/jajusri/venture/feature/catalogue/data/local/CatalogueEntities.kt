package com.jajusri.venture.feature.catalogue.data.local

import androidx.room.Entity
import androidx.room.Index

/**
 * MVP-1.4 Catalogue Room entities (docs/architecture/VENTURE-MVP-1-4-CATALOGUE-ARCHITECTURE.md §6,
 ...
 * ([com.jajusri.venture.feature.masterdata.stockitem.data.local.StockItemEntity]) via
...
data class CatalogueProductEntity(
     ...
     * Tally-linked product's Unit remains exclusively [com.jajusri.venture.feature.masterdata.stockitem.domain.model.StockItem.baseUnit],
     * resolved live and never mirrored here, per this table's own "never store a Tally-owned field"
     * discipline (see this file's top-level doc comment). [com.jajusri.venture.feature.catalogue.data.repository.CatalogueRepositoryImpl]
    ...
    /** "OPEN" or "CONTACT_FOR_PRICE" — [com.jajusri.venture.feature.catalogue.domain.model.PriceDisplayMode] name. */
    val priceDisplayMode: String,
    val manualPriceAmount: String?,
    val manualPriceCurrencyCode: String?,
    /** "DRAFT" / "REVIEW" / "PUBLISHED" / "ARCHIVED" — [com.jajusri.venture.feature.catalogue.domain.model.CatalogueLifecycleState] name. */
 ...
 * [com.jajusri.venture.feature.party.data.local.PartySourceLinkEntity]'s exact shape/discipline
 ...
 * [com.jajusri.venture.feature.catalogue.data.repository.CatalogueRepositoryImpl.isPublic]), never
 ...
 * [com.jajusri.venture.feature.catalogue.data.local.CataloguePublishedSnapshotDao.publish]) on every
 ...
 * tripped opaquely; VENTURE never interprets their content"). Without this table, a custom column's
 * *name* survives round-trip (via [com.jajusri.venture.feature.catalogue.domain.excel.CatalogueExcelImportPreview.customColumnNames])
 ...
 * matched case-insensitively elsewhere per [com.jajusri.venture.feature.catalogue.domain.excel.CatalogueExcelColumns.isReserved]'s
 ...
 * relative to [com.jajusri.venture.feature.catalogue.storage.CatalogueAssetStore]'s own managed

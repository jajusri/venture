package com.jajusri.venture.feature.dincharya.domain.model
...
sealed interface DincharyaItem {
    ...
    /**
     * Type A — a `commitment`/`follow_up` [com.jajusri.venture.feature.party.domain.model.PartyNote]
     ...
     * [com.jajusri.venture.feature.party.domain.model.FieldProvenanceState.Exported] (MVP-1.1-D),
     ...
     * reuses [com.jajusri.venture.core.util.PhoneNumberNormalizer] exactly (the same

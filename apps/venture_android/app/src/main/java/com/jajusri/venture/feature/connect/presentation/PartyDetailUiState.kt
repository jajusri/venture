...
data class PartyDetailUiState(
     ...
     * second, separately-fetched list — see [com.jajusri.venture.feature.connect.presentation.PartyDetailViewModel]). */
...
sealed interface PartyDetailEvent {
     ...
     * The only UI path to [com.jajusri.venture.feature.party.domain.usecase.SetNoteCompletionUseCase],
...
internal fun FieldProvenanceState.toUiLabel(): String = when (this) {
    ...
    FieldProvenanceState.VentureOnlyPending -> "Pending in VENTURE"

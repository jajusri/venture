...
import com.jajusri.venture.feature.party.domain.model.LedgerPartyEligibilityPolicy
...
class UpdateVentureOnlyFieldUseCase @Inject constructor(private val repository: PartyRepository) {
    suspend operator fun invoke(companyId: String, partyId: String, fieldName: String, value: String?): FieldProvenanceState =
        repository.updateVentureOnlyField(companyId, partyId, fieldName, value)
}

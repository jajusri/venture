...
data class TransactionComposerUiState(
     ...
     * [com.jajusri.venture.feature.catalogue.sharing.CatalogueShareContent] itself uses). Loaded by
 ...
 * [com.jajusri.venture.feature.transaction.domain.model.CatalogueAccessGrant], the still-unresolved
...
sealed interface TransactionComposerEvent {
     ...
     * [com.jajusri.venture.feature.transaction.domain.model.ReorderOperations] — never mutates that
     ...
     * ([com.jajusri.venture.feature.transaction.data.port.LocalTransactionSubmissionPort]'s own

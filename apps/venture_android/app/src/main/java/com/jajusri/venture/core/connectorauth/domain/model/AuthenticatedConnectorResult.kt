...
/**
 * Outcome of one [com.jajusri.venture.core.connectorauth.data.remote.AuthenticatedConnectorApiPort]
 * call. Distinguishes context-resolution failures (no request was ever attempted — see
 * [com.jajusri.venture.core.connectorauth.domain.AuthenticatedConnectorContextResolution]) from
...
sealed class AuthenticatedConnectorResult {
     ...
     * [com.jajusri.venture.core.pairing.domain.model.SecurePairingCredentialRecord.credentialId]

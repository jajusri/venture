...
/**
 * Business Profile (MVP-1.3-A) — a single VENTURE-owned identity record per selected Tally company
 * (PDL-019). Reloads fresh on every company change, mirroring
 * [com.jajusri.venture.feature.connect.presentation.ConnectViewModel]/
 * [com.jajusri.venture.feature.dincharya.presentation.DincharyaViewModel]'s own

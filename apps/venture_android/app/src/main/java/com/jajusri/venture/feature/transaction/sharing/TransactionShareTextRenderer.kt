 ...
 * [com.jajusri.venture.feature.catalogue.sharing.CatalogueShareTextRenderer]'s own doc comment (no
...
object TransactionShareTextRenderer {
    ...
    fun render(
        ...
        appendLine(businessName?.trim()?.takeIf(String::isNotBlank) ?: "VENTURE")
     ...
     * [com.jajusri.venture.feature.catalogue.sharing.CatalogueShareTextRenderer]'s own three-way

package com.jajusri.venture.core.trust.domain
 ...
 * [com.jajusri.venture.feature.transaction.domain.port.DeviceSigningIdentity] (that type lives in
 * the protected `feature/transaction` package this module must not depend on for anything beyond
 * read-only interface satisfaction -- see [com.jajusri.venture.core.trust.data.TrustBackedRelayCredentialSource]).
 */

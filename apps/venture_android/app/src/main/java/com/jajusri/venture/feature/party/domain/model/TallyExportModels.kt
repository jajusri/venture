 ...
 * ledger XML). Every VENTURE-only field (tags, notes, extra contact persons, classification,
 ...
 * mapping here would be an invented convention Tally itself doesn't support, and a value VENTURE
...
/** One eligible field's export-review row: what Tally last confirmed (if anything), what VENTURE

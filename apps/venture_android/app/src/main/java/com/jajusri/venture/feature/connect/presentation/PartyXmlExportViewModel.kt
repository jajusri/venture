...
import com.jajusri.venture.feature.party.domain.usecase.GetExportCandidatesUseCase
import com.jajusri.venture.feature.party.domain.usecase.GetExportHistoryUseCase
...
import com.jajusri.venture.feature.party.domain.usecase.ReconcileExportedFieldFromTallyUseCase
import com.jajusri.venture.feature.party.domain.usecase.RecordExportUseCase
import com.jajusri.venture.feature.party.domain.xml.TallyLedgerXmlGenerator
import com.jajusri.venture.feature.party.sharing.PartyXmlExportCoordinator
import com.jajusri.venture.feature.party.sharing.PartyXmlExportResult
import com.jajusri.venture.feature.party.sharing.PreparedPartyXmlExport
import com.jajusri.venture.feature.party.sharing.sanitizedPartyXmlExportFilename
 ...
 * Prospect (no [com.jajusri.venture.feature.party.domain.model.PartySourceLink] exists) — Party
    ...
    private fun load() {
        viewModelScope.launch {
            ...
            val defaultSelection = candidates
                .filter { it.state == FieldProvenanceState.VentureOnlyPending || it.state == FieldProvenanceState.Conflict }
                .map { it.fieldName }
                .toSet()
    ...
    private fun generate() {
        ...
        viewModelScope.launch {
            ...
            val fields = state.candidates
                ...
                .mapNotNull { candidate -> candidate.ventureValue?.let { candidate.fieldName to it } }
                .toMap()

            if (fields.isEmpty()) {
                _uiState.update { it.copy(isGenerating = false, notice = "The selected field(s) have no VENTURE value to export.") }
                return@launch
            }

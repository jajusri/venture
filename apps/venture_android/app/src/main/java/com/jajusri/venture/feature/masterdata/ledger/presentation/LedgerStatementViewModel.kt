...
import com.jajusri.venture.feature.masterdata.ledger.sharing.RecipientResolution
import com.jajusri.venture.feature.masterdata.ledger.sharing.resolveWhatsAppRecipient
...
class LedgerStatementViewModel @Inject constructor(
     ...
     * [com.jajusri.venture.feature.voucher.presentation.VoucherDetailsViewModel] for the identical
    ...
    fun onEvent(event: LedgerStatementEvent) {
        when (event) {
            ...
            is LedgerStatementEvent.ShareLedgerWithMode -> {
                val state = _uiState.value
                shareStatement(
                    period = state.periodSelection,
                    mode = event.mode,

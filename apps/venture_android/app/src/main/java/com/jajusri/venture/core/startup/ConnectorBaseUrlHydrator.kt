package com.jajusri.venture.core.startup
...
interface ConnectorBaseUrlHydrator {
    /**
     * Reads the saved URL (or build default when none) and updates [com.jajusri.venture.core.network.ConnectorBaseUrlProvider].

...
sealed interface AcceptSellerInboxEntryResult {
    ...
    /** [ProposedTerms.note] exceeded [com.jajusri.venture.feature.transaction.domain.model.MAX_TERMS_NOTE_LENGTH]. */
...
interface TransactionRepository {
    ...
    suspend fun ingestReceivedCommercialEvent(
        recipientCompanyId: String,
        item: RelayMailboxDeliveryItem,
        event: CommercialReturnEvent,
        timestamp: TransactionTimestamp,
    ): Boolean = throw UnsupportedOperationException("Atomic commercial event ingestion is not implemented by this repository")
     ...
     * via the injected [com.jajusri.venture.feature.transaction.domain.port.TransactionSubmissionPort]
    ...
    suspend fun recordPaymentClaim(
        ...
        currencyCode: String?,
        isFinalOrPartial: com.jajusri.venture.feature.transaction.domain.model.PaymentClaimStatus,
        timestamp: TransactionTimestamp,
    ): PaymentEvent?
     ...
     * has to re-derive [com.jajusri.venture.feature.transaction.domain.model.TransactionStateDerivation]
     * by hand. */
    ...
    suspend fun grantCatalogueAccess(
        ...
        timestamp: TransactionTimestamp,
    ): com.jajusri.venture.feature.transaction.domain.model.CatalogueAccessGrant
     ...
     * [com.jajusri.venture.feature.transaction.domain.model.CatalogueAccessGrant.isActive]. */
    suspend fun findActiveCatalogueAccessGrant(companyId: String, buyerPartyId: String, nowEpochMillis: Long): com.jajusri.venture.feature.transaction.domain.model.CatalogueAccessGrant?
}
...
data class TransactionSnapshot(
    ...
    val mutualAgreementStatus: com.jajusri.venture.feature.transaction.domain.model.TransactionStateDerivation.MutualAgreementStatus,

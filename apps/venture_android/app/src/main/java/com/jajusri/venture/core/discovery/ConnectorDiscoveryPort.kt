package com.jajusri.venture.core.discovery

/**
 * A Venture Connector instance found via LAN service discovery (mDNS/NSD), advertising
 * `_venture._tcp` with non-sensitive TXT metadata only (matches connector's mdns-advertiser).
 */
data class DiscoveredConnector(
     ...
     * enrolment/reconnection paths ([com.jajusri.venture.core.connection.ConnectorConnectionResolver],
     * [com.jajusri.venture.core.connection.ConnectorEnrolmentService]) dial it directly as

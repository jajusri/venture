...
import com.jajusri.venture.feature.transaction.domain.port.AuthenticatedEnvelopeBinder
...
class KeystoreRelayEnvelopeAuthenticator @Inject constructor(
    ...
    override suspend fun authenticate(envelope: OrderDeliveryEnvelope): AuthenticatedTransportEnvelope? {
        ...
        val contentType = envelope.commercialContentType ?: com.jajusri.venture.feature.transaction.domain.port.ORDER_SNAPSHOT_CONTENT_TYPE
        val contentVersion = envelope.commercialContentVersion ?: com.jajusri.venture.feature.transaction.domain.port.ORDER_SNAPSHOT_CONTENT_VERSION

 ...
 * (docs/architecture/VENTURE-TRANSACTION-MODE-ARCHITECTURE.md §5, §8).
 *
 * Follows the exact discipline
 * [com.jajusri.venture.feature.catalogue.domain.model.CatalogueLifecycleTransitions] already
...
object TransactionStateDerivation {
     ...
     * single source of truth [com.jajusri.venture.feature.transaction.data.repository.TransactionRepositoryImpl]

...
interface PartyDao {
     ...
     * computed by [com.jajusri.venture.core.util.PhoneNumberNormalizer.normalizeForSearch] — never a
     ...
     * ([com.jajusri.venture.feature.party.data.repository.PartyRepositoryImpl]'s

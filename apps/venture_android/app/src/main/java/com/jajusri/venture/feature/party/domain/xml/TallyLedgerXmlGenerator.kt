package com.jajusri.venture.feature.party.domain.xml
 ...
 * contact-compatible fields (MVP-1.1-D). VENTURE never sends this to Tally itself — it is written
 ...
 *
 * **Known, disclosed Tally XML limitation** (not a VENTURE shortcut): Tally's XML `ACTION="Alter"`

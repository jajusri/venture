import type { ConfigLoadResult } from './desktop-config-store.js';
...
export class RecoveryService {
  ...
  handleConfigLoad(result: ConfigLoadResult): RecoveryAction {
  ...
  describeFailure(code: string, detail?: string): RecoveryAction {
    const catalog: Record<string, Omit<RecoveryAction, 'result'>> = {
      PORT_IN_USE: {
        code,

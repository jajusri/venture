...
/** The marker file VENTURE writes onto the selected removable volume itself, at `<drive>\VenturePrivate\vault.json`. */
...
export const VENTURE_PRIVATE_ROOT_FOLDER = 'VenturePrivate';
export const VENTURE_VAULT_MARKER_FILE = 'vault.json';

...
async function capture(): Promise<void> {
  ...
  await window.webContents.executeJavaScript(`
    ...
    document.getElementById('header-company').textContent = 'Venture-Test-01';
    document.getElementById('company-list-status').textContent = '2 companies available';
    document.getElementById('company-list').innerHTML = '<button type="button" class="company-item selected" data-company-id="venture-test-01" role="radio" aria-checked="true" tabindex="0"><span class="company-radio" aria-hidden="true"></span><span class="company-name">Venture-Test-01</span><span class="company-id">venture-test-01</span></button><button type="button" class="company-item" data-company-id="estimation" role="radio" aria-checked="false" tabindex="-1"><span class="company-radio" aria-hidden="true"></span><span class="company-name">ESTIMATION</span><span class="company-id">estimation</span></button>';
    ...
    document.getElementById('footer-company').textContent = '· Venture-Test-01';

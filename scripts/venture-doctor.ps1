# VENTURE development environment doctor (read-only).
# Usage: .\scripts\venture-doctor.ps1
...
$AndroidDir = Join-Path $RepoRoot 'apps\venture_android'
$DesktopDir = Join-Path $RepoRoot 'apps\venture_desktop'
...
Write-Host '=== VENTURE Doctor (read-only) ==='
Run-GitCheck
Run-NodeCheck
Run-DesktopCheck
Run-AndroidCheck

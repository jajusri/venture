 ...
 *
 * On LAN: requires header `X-Budcom-Desktop-Control-Token` to exactly match
 ...
 *
 * Wiring Desktop to actually generate and pass BUDCOM_DESKTOP_CONTROL_TOKEN (mirroring the
 * existing BUDCOM_CONNECTOR_ID pattern) and to attach this header on its own calls is deferred

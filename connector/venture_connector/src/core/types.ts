...
export interface HealthReport {
  ...
  /** True once the mDNS advertiser (_venture._tcp.local) is actively publishing. */
  readonly discoveryAdvertising: boolean;
  readonly services: readonly ServiceStatus[];
  /** Present when desktop supervisor supplied VENTURE_STARTUP_CORRELATION_ID for this launch. */
   ...
   * (docs/architecture/VENTURE-MVP-1-4-CATALOGUE-ARCHITECTURE.md §15) needs a non-device-local

 ...
 * Keep values aligned with apps/venture_desktop/src/application/release/release-mode.ts
 */
...
export function resolveConnectorReleaseMode(envValue = process.env.VENTURE_RELEASE_MODE): ReleaseMode {

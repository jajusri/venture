...
export const PRODUCTION_VOUCHER_COLLECTION_NAME = 'Venture Voucher Discovery' as const;
export const PRODUCTION_VOUCHER_LEDGER_SOURCE_NAME = 'Venture Voucher Ledger Source' as const;
export const PRODUCTION_VOUCHER_LEDGER_COLLECTION_NAME = 'Venture Voucher Ledger Entries' as const;
export const PRODUCTION_VOUCHER_INVENTORY_SOURCE_NAME = 'Venture Voucher Inventory Source' as const;
export const PRODUCTION_VOUCHER_INVENTORY_COLLECTION_NAME =
  'Venture Voucher Inventory Entries' as const;
export const PRODUCTION_VOUCHER_DATE_FILTER_NAME = 'VentureVoucherDateRange' as const;

...
/** Live Venture-Test-01 single-day voucher export measured ~1.06 MiB (2026-07-29). */
...
const REGISTRY: Readonly<Record<ApprovedOperationId, ApprovedOperation>> = Object.freeze({
  ...
  [ApprovedOperationId.LedgersContactDetails]: {
    ...
    // project's standing rule (VENTURE-ADAPTIVE-TALLY-SYNC-ARCHITECTURE.md's Tally-request-safety
  ...
  [ApprovedOperationId.Vouchers]: {
    ...
    timeoutMs: 30_000,
    autoApproveConditional: false,
    evidenceSource: 'live Venture-Test-01 2026-07-24: 14 metadata records / 18279 bytes / valid XML',
    rolloutStatus: 'production',
  ...
  [ApprovedOperationId.VoucherLedgerEntries]: {
    ...
    erpType: 'tally',
    adapterVersion: ADAPTER_VERSION,
    tallyEvidenceBuild: 'TallyPrime Venture-Test-01 (2026-07-29)',
    capability: TallyCapability.ReportRead,
    tallyRequest: 'Export',
    requestKind: 'Collection',
  ...
  [ApprovedOperationId.VoucherInventoryEntries]: {
    ...
    erpType: 'tally',
    adapterVersion: ADAPTER_VERSION,
    tallyEvidenceBuild: 'TallyPrime Venture-Test-01 (2026-07-30)',
    capability: TallyCapability.ReportRead,
    tallyRequest: 'Export',
    requestKind: 'Collection',

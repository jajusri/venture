...
const NONEXISTENT_COMPANY = 'VENTURE-NONEXISTENT-COMPANY-VALIDATION';
const INVALID_REPORT_ID = 'VENTURE-INVALID-REPORT-VALIDATION';
...
async function main(): Promise<void> {
  ...
  const requestedCompany = resolveRequestedCompanyContext(process.env.VENTURE_TALLY_TEST_COMPANY);
        ...
        JSON.stringify(
          {
            ...
            guidance:
              'Dismiss any open Tally modal, confirm the populated test company is selected, verify VENTURE_TALLY_TEST_COMPANY, then rerun validation-only.',

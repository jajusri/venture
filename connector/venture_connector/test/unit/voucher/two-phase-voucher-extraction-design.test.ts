...
const DISCOVERY_COLLECTION = `<COLLECTION NAME="Venture Voucher Discovery" ISMODIFY="No" ISFIXED="No" ISINITIALIZE="Yes">
  <TYPE>Voucher</TYPE>
...
const LEDGER_COLLECTIONS = `<COLLECTION NAME="Venture Voucher Ledger Source" ISMODIFY="No" ISFIXED="No" ISINITIALIZE="Yes">
  <TYPE>Voucher</TYPE>
  <FILTERS>VentureVoucherDateRange</FILTERS>
  <NATIVEMETHOD>GUID</NATIVEMETHOD>
</COLLECTION>
<COLLECTION NAME="Venture Voucher Ledger Entries" ISMODIFY="No" ISFIXED="No" ISINITIALIZE="Yes">
...
describe('two-phase Voucher and ledger extraction design', () => {
  it('keeps discovery minimal, bounded, and independent from monetary child data', () => {
    expect(DISCOVERY_COLLECTION).toContain('<FILTERS>VentureVoucherDateRange</FILTERS>');

  ...
  it.each(['Discount', 'BatchDiscount'])(
    ...
    (method) => {
      const xml = new TallyXmlRequestBuilder().buildEmbeddedCollection({
        collection: {
          name: `Venture Discount Probe ${method}`,
          sourceCollection: 'Venture Discount Source',
        ...
        supportingCollections: [{
          name: 'Venture Discount Source',
          objectType: 'Voucher',
          fetch: ['GUID'],
          filters: ['VentureVoucherDateRange'],
        }],
        staticVariables: {
          SVEXPORTFORMAT: '$$SysName:XML',
          SVCURRENTCOMPANY: 'Venture-Test-01',
          SVFROMDATE: '20260724',
          SVTODATE: '20260724',
        },
        systemFormulae: {
          VentureVoucherDateRange:

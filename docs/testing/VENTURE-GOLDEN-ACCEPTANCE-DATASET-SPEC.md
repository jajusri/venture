# VENTURE Golden Acceptance Dataset Specification
...
This dataset is not ordinary production data. It is a permanent acceptance fixture representing difficult but realistic VENTURE business cases.

Every important release should be able to answer:

> Does VENTURE still produce the expected result against the same known accounting truth?
...
Never change the expected result merely because VENTURE currently disagrees.
...
- Give it a clearly recognizable name, e.g. `VENTURE_ACCEPTANCE`.

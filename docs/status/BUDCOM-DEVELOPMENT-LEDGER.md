...
blocker remains unrelated to and unchanged by MVP-1.1. The next development milestone is MVP-1.2
(planning/recovery review only — not started). Do not start MVP-1.2 substantively, and do not start
external distribution, before an explicit go-ahead.

...
MVP-1.4 must preserve all existing BUDCOM architectural boundaries, including:

* Tally remains **read-only** from BUDCOM.
...
# BUDCOM MVP-1.4 CATALOGUE — BRAINSTORM OUTCOME

## Purpose
This document is the handover output of the MVP-1.4 Catalogue Brainstorm session, conducted following the sequence and rules set out in `BUDCOM-MVP-1_4-CATALOGUE-BRAINSTORM-CONTEXT.md`.

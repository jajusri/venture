...
**Why valuable:** A VENTURE Prospect (a pre-relationship record with no accounting ledger yet)
...
**Concept (exact, for the eventual design session):** A VENTURE Prospect may later be explicitly
linked to an already-synced Tally ledger (Debtor or Creditor). Rules: (1) the ledger must already
exist in VENTURE's synced local Ledger data — never a newly-created Tally ledger; (2) linking is
...
(`docs/status/VENTURE-DEVELOPMENT-LEDGER.md` §26); (8) Debtor/Creditor classification must come from

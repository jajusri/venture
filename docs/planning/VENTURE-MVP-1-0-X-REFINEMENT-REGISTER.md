# VENTURE MVP-1.0.x Refinement Register

**Status:** Active
**Governance:** `POST-MVP-1-DEVELOPMENT-MODUS-OPERANDI.md`, `VENTURE-MASTER-PRODUCT-EXECUTION-PLAN.md` (release boundary), `VENTURE-PRODUCT-DECISION-LOG.md` (PDL-005)
...
- **Increase product scope → post-MVP roadmap** (`VENTURE-MASTER-PRODUCT-EXECUTION-PLAN.md`), not this register.
...
**Touches:** `apps/venture_android/app/src/main/java/com/jajusri/venture/feature/voucher/` list row rendering (Compose UI).
...
called for in `VENTURE-UI-DESIGN-DECISIONS.md` §5 was found missing during the MVP-1 UI/UX polish
...
`VoucherBrowserViewModelTest` cases. See `docs/design/VENTURE-MVP-1-UI-UX-POLISH-STATUS.md` §3 for
full detail and the wider polish pass this landed alongside.

**Touches:** `apps/venture_android/app/src/main/java/com/jajusri/venture/feature/voucher/presentation/`.
...
`docs/design/VENTURE-MVP-1-UI-UX-POLISH-STATUS.md` §3–4; that document's §6–7 record the P2/DEFER
items explicitly left for a future pass or product decision.

**Touches:** see the status document's full file list — spans `apps/venture_android` presentation
layer and `apps/venture_desktop` renderer.
...
4. the Quality Scorecard (`VENTURE-QUALITY-SCORECARD.md`) shows no blocking
...
all-at-once event — see `VENTURE-RELEASE-LADDER-AND-ROLLBACK.md` for the
...
- `docs/design/VENTURE-UI-DESIGN-DECISIONS.md` — locked visual direction;
  ...
  direction.
- `VENTURE-MASTER-PRODUCT-EXECUTION-PLAN.md` — anything that increases scope
  moves there instead of staying here.
- `VENTURE-PRODUCT-DECISION-LOG.md` PDL-005 — the locked 1.0.x boundary

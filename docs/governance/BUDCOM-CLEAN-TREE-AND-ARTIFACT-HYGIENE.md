...
`D:\BUDCOM-Design-Archive\` is an intentional example of category 2/3
...
`docs/design/BUDCOM-UI-DESIGN-DECISIONS.md`), but it must never be copied
...
Isolated release worktrees (`D:/tmp/budcom-release-<short-sha>` and similar)
...
This file is itself subject to `BUDCOM-EVIDENCE-OVER-BUREAUCRACY-PRINCIPLE.md`.

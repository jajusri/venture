# BUDCOM Threat Model and Security Register

**Status:** Initial locked framework; update continuously with evidence  
**Purpose:** Define BUDCOM assets, trust boundaries, attack surfaces, security assumptions, threats, mitigations, residual risks, and verification evidence.

## 1. Security principle

Security decisions must be evidence-driven and proportional to risk. BUDCOM must fail closed where trust cannot be established, preserve user control over consequential operations, and avoid silently weakening security for convenience.
...
### Tally
Authoritative accounting system. BUDCOM reads approved data and does not directly mutate Tally under current governance.

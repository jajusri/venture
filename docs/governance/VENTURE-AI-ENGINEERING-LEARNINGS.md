# VENTURE AI Engineering Learnings

**Status:** Living empirical knowledge base  
**Purpose:** Preserve what the VENTURE team has actually learned about AI tools, debugging methods, validation strategies, workflow failures, and successful recovery patterns so future work can reuse proven approaches instead of rediscovering them.  
...
VENTURE development has already produced valuable practical knowledge that goes beyond architecture and product decisions.
...
When a future VENTURE task becomes difficult, first ask:
...
- **High confidence** — repeated real VENTURE evidence
...
- `VENTURE-CLAUDE-PROMPT-PROCESSING-RULES.md` — how Claude processes prompts;
- `VENTURE-MASTER-PRODUCT-EXECUTION-PLAN.md` — what gets built and how capacity/cost are planned;
- `VENTURE-PRODUCT-DECISION-LOG.md` — consequential product decisions;
- `VENTURE-DEVELOPMENT-ECONOMICS-LOG.md` — empirical time/usage/cost evidence.

Together, these files preserve both VENTURE's **rules** and its **experience**.

---

## Final Principle

> When VENTURE gets stuck, do not begin from zero.  

...
| Upgrade/release readiness | 2 | **Updated 2026-08-16 (autonomous hardening run).** Desktop 0.4.12 physically confirmed Session 2 in full (see Physical validation row). Current candidates: Desktop `0.4.14` / Connector `0.4.5` (TD-029+TD-030, closure doc §35-§37) and Android `continuity.16`/versionCode 17 debug APK, SHA-256 `0c2e724e07521724ee744114a0b6a74318d07f0edecc81f4026f5d5e742ea136` (TD-028 PDF preview, closure doc §39) — Desktop/Connector and Android changed independently this run, each for its own reason, neither bumped merely for appearance. Still capped at 2, not higher: Android has no signed-release path at all (no keystore in this environment); neither new candidate has been physically retested yet; Sessions 1/4/5 haven't run, and Session 3 is paused pending the combined TD-029+TD-030 physical retest. |

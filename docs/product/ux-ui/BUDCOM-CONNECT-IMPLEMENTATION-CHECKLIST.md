# BUDCOM — Connect Implementation Checklist

Status: IMPLEMENTATION-READY BASELINE
Scope: Post-MVP-1 Connect, beginning with Quiet/Normal BUDCOM
Authority: BUDCOM-AUTHORITATIVE-UX-UI-SPECIFICATION-v1.docx

## Execution order

1. Connect Screen 1 — Contacts list (Quiet/Normal BUDCOM)
...
6. Tally-group import + BUDCOM product-relevance refinement
...
- Quiet/Normal BUDCOM first; BI overlay later.

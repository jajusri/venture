# CLAUDE IMPLEMENTATION PROMPT — BUDCOM CONNECT SCREEN 1 (QUIET/NORMAL MODE) v2

Read and follow:
1. `docs/product/ux-ui/BUDCOM-AUTHORITATIVE-UX-UI-SPECIFICATION-v1.docx`
2. `docs/product/ux-ui/BUDCOM-ACCOUNTING-OPTIONAL-UX-PRINCIPLE.md`
3. `docs/product/ux-ui/BUDCOM-CONNECT-IMPLEMENTATION-CHECKLIST-v2.md`

## Critical overriding product requirement

BUDCOM MUST work as a useful business Contacts product when the user has NO accounting software connected.
...
- how to represent a BUDCOM-native Party before a Tally ledger exists,
...
### State A — BUDCOM-only / no accounting
...
- Use BUDCOM-native last activity only if a reliable activity exists; otherwise keep the card clean.
- Search/filter/sort remain useful using BUDCOM-native fields.
...
- A–Z / Z–A
- BUDCOM-native last activity where reliable
...
3. accounting source temporarily unavailable preserves last trustworthy synced enrichment without breaking BUDCOM-native Contacts;

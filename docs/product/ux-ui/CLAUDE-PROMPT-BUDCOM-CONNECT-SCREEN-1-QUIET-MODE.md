# CLAUDE IMPLEMENTATION PROMPT — BUDCOM CONNECT SCREEN 1 (QUIET/NORMAL MODE)

You are implementing a single bounded milestone in the BUDCOM repository.
...
This task is ONLY:
**Connect Screen 1 — Contacts List, Quiet/Normal BUDCOM.**
...
Quiet/Normal BUDCOM default visual hierarchy:
...
- Preserve the earlier clean BUDCOM white/light visual language: calm, near-neutral, information-dense but comfortable.

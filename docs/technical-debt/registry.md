...
| **Status** | Open — targeted fix in progress (Phase 3U-5, 2026-08-08) |
...
| TD-013 | Post-pairing reconnection loses selected company / authenticated transport blocks auto-recovery | P0 | Open — fix in progress | Pre-MVP-1 release hardening |

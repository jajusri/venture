...
| **Priority** | P0 |
| **Target milestone** | Pre-MVP-1 release hardening |
| **Status** | Open — root-caused, fix in progress |
...
| TD-017 | Authenticated Android reconnect permanently pins pairing-time Connector endpoint | P0 | Open — root-caused, fix in progress | Pre-MVP-1 release hardening |

...
| **Required physical confirmation** | One fresh Voucher sync against ESTIMATION on Desktop `0.4.12` (SHA-256 `f646aa5bf28065bb7937ba09f8130e9f6d1683019665ce2af8f7deaa0d7b45ec`, bundling Connector `0.4.4`; Android `continuity.15` unchanged). Expected: sync completes; the audit file, if anything is recorded, should show a *successful* run, not a failure. Report voucher counts, any `amountSignConflictCount` > 0 observed, and whether existing voucher data/totals remain correct. |
